...
//   booked: an existing booking holds that time
function slotsForDate(dateStr, schedule, bookings) {
...
module.exports = { slotsForDate, bookingWindow, isDateStr, isTimeStr, parseTime };
